...
import {SidebarProvider,Sidebar,SidebarContent,SidebarHeader,SidebarMenuButton,SidebarMenu,SidebarMenuItem,SidebarMenuSub,} from './ui/sidebar';
              ...
              <SidebarMenuItem>
                ...
                <CollapsibleContent>
                  ...
                  {/* ZIP Code Borders Toggle */}
                    <div className="flex items-center justify-between p-2">
                      <label className="text-sm font-medium">Show ZIP Borders</label>
                      <Switch 
